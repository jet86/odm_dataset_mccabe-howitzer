...
![Screenshot of splat processed with WebODM and OpenSplat, displayed in WebODM](Howitzer_Splat.png)

Screenshot of Point Cloud processed and displayed in WebODM:

![Screenshot of Point Cloud processed and displayed in WebODM](Howitzer_PC.png)

Screenshot of Textured Model processed and displayed in WebODM:

![Screenshot of Textured Model processed and displayed in WebODM](Howitzer_Textured.png)

Reference photo of the Howitzer from a similar location to the above 3D models:

![Reference photo of the Howitzer from a similar location to the above 3D models](images/IMG_6651.jpeg)
